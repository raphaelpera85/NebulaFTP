...
def main():
    ...
    print(f"Total inventory items: {len(items)}, Live MongoDB docs: {len(docs)}")
    ...
    print(f"\nSUCCESS: Realigned {applied} files to true stream content, quarantined {quarantined} duplicates!")
